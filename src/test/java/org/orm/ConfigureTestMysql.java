...
//    }
    @Test
    void getTableName(){
        String name=Configure.getSession("my").getTableName(MyTable.class);
        assert name!=null;
 ...
 @Test
    ...
    void autoClose() throws Exception {
        ...
        Configure.getSessionAuto("my").dropTableIfExists(MyTable.class);
        Configure.getSessionAuto("my").createTableIfNotExists(MyTable.class);
        boolean alive=Configure.getSessionAuto("my").IsAlive();
        if(alive==true){
            throw new Exception();
        }
        ...
        for (int i = 0; i < 10; i++) {
            ...
            myTable.name = "123";
            myTable.stringList.add("123");
            Configure.getSessionAuto("my").insertBulk(myTable);
        }
    }
    ...
    void transaction() throws Exception {
        ...
        try (ISession session = Configure.getSession("my")) {
            ...
            List<MyTable> list=Configure.getSessionAuto("my").getList(MyTable.class,null);
            assert  list.size()==0;
    ...
    void transaction2() throws Exception {
        ...
        try (ISession session = Configure.getSession("my")) {
            ...
            assert  list.size()==0;
            session.commitTransaction();
            list=Configure.getSessionAuto("my").getList(MyTable.class,null);
            assert  list.size()==1;
